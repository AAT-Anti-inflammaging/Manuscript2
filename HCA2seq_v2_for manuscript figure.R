...
ggplot(as.data.frame(resSig)) + aes(x=-log(padj),y=log2FoldChange) + geom_jitter(color = "orange", size = 2) + 
  ...
  geom_text_repel(aes(label=rownames(resSig)), color = "blue")  + 
  theme_minimal() + theme(axis.title = element_text(size = 18),
                          axis.text =  element_text(size = 16))
ggsave("DEGs.png", units="in", width=6, height=4, dpi=600)
...
png("CountHeatMap.png", width = 5, height = 4, units = 'in', res = 600)
...
ggsave("EnrichmentMap.png", units="in", width=5, height=4, dpi=600)
# enrichment map
...
ggsave("cnetplot.png", units="in", width=5, height=4, dpi=600)
...
ggplot(tfplot, aes(x=factor(tflevel, levels = tflevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  geom_point(size = 3) + coord_flip() + ylab("Combined Score") + xlab("") + ggtitle("TRUST Transcription Factor 2019\n(Down-regulated)") + 
  ...
  theme(axis.title = element_text(size = 18),
        ...
        plot.title = element_text(hjust = 0.5))
ggsave("ttf2019.png", units="in", width=6, height=4, dpi=600)
...
ggplot(jplot, aes(x=factor(jlevel, levels = jlevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  geom_point(size = 3) + coord_flip() + ylab("Combined Score") + xlab("") + ggtitle("TRANSFAC and JASPAR PWMs\n(Down-regulated)") + 
  scale_colour_gradient(name = "Negative\nLogarithm\nof Adjusted\nP-value", 
                        low = "orange", high = "blue") + theme_bw() + 
  theme(axis.title = element_text(size = 18),
        axis.text.y =  element_text(size = 10, face = "bold"),
        ...
        legend.text = element_text(size = 14),
        plot.title = element_text(hjust = 0.5))
ggsave("tfjaspar.png", units="in", width=6, height=4, dpi=600)
...
ggplot(ppiplot, aes(x=factor(ppilevel, levels = ppilevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  geom_point(size = 3) + coord_flip() + ylab("Combined Score") + xlab("") + ggtitle("Transcription Factor PPIs\n(Down-regulated)") + 
  scale_colour_gradient(name = "Negative\nLogarithm\nof Adjusted\nP-value", 
                        low = "orange", high = "blue") + theme_bw() + 
  theme(axis.title = element_text(size = 18),
        axis.text.y =  element_text(size = 10, face = "bold"),
        ...
        legend.text = element_text(size = 14),
        plot.title = element_text(hjust = 0.5))
ggsave("tfppi.png", units="in", width=6, height=4, dpi=600)
...
ggplot(kplot, aes(x=factor(klevel, levels = klevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  geom_point(size = 3) + coord_flip() + ylab("Combined Score") + xlab("") + ggtitle("KEGG Pathway 2019\n(Down-regulated)") + 
  scale_colour_gradient(name = "Negative\nLogarithm\nof Adjusted\nP-value", 
                        low = "orange", high = "blue") + theme_bw() + 
  theme(axis.title = element_text(size = 18),
        axis.text.y =  element_text(size = 10, face = "bold"),
        ...
        legend.text = element_text(size = 14),
        plot.title = element_text(hjust = 0.5))
ggsave("kegg.png", units="in", width=7.5, height=4, dpi=600)
...
ggplot(wikiplot, aes(x=factor(wikilevel, levels = wikilevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  geom_point(size = 3) + coord_flip() + ylab("Combined Score") + xlab("") + ggtitle("Wiki Pathway 2019\n(Down-regulated)") + 
  scale_colour_gradient(name = "Negative\nLogarithm\nof Adjusted\nP-value", 
                        low = "orange", high = "blue") + theme_bw() + 
  theme(axis.title = element_text(size = 18),
        axis.text.y =  element_text(size = 10, face = "bold"),
        ...
        legend.text = element_text(size = 14),
        plot.title = element_text(hjust = 0.5))
ggsave("wiki.png", units="in", width=10, height=4, dpi=600)
...
ggplot(kupplot, aes(x=factor(kuplevel, levels = kuplevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  ...
  theme(axis.title = element_text(size = 18),
        ...
        legend.text = element_text(size = 14),
        plot.title = element_text(hjust = 0.5))
ggsave("keggup.png", units="in", width=8.5, height=4, dpi=600)
...
ggplot(ontoplot, aes(x=factor(ontolevel, levels = ontolevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  geom_point(size = 3) + coord_flip() + ylab("Combined Score") + xlab("") + ggtitle("GO Biological Process 2018\n(Down-regulated)") + 
  scale_colour_gradient(name = "Negative\nLogarithm\nof Adjusted\nP-value", 
                        low = "orange", high = "blue") + theme_bw() + 
  theme(axis.title = element_text(size = 18),
        axis.text.y =  element_text(size = 10, face = "bold"),
        ...
        legend.text = element_text(size = 14),
        plot.title = element_text(hjust = 0.5))
ggsave("GO.png", units="in", width=8.5, height=4, dpi=600)
...
ggplot(ontoupplot, aes(x=factor(ontouplevel, levels = ontouplevel), y=Combined.Score, color=-log(Adjusted.P.value)))  + 
  ...
  theme(axis.title = element_text(size = 18),
        ...
        legend.text = element_text(size = 14),
        plot.title = element_text(hjust = 0.5))
ggsave("GOup.png", units="in", width=8.5, height=4, dpi=600)
